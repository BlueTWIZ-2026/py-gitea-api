...
class NodeInfoUsage(object):
    ...
    def local_comments(self):
        ...
        LocalComments is the total amount of comments made by users local to this server  # noqa: E501
    ...
    def local_posts(self):
        ...
        LocalPosts is the total amount of posts made by users local to this server  # noqa: E501
