...
class GeneralAPISettings(object):
    ...
    def __init__(self, default_git_trees_per_page=None, default_max_blob_size=None, default_max_response_size=None, default_paging_num=None, max_response_items=None, _configuration=None):  # noqa: E501
        ...
        self._default_max_response_size = None
        ...
        if default_max_response_size is not None:
    ...
    def default_git_trees_per_page(self):
        ...
        DefaultGitTreesPerPage is the default number of Git tree items per page  # noqa: E501
    ...
    def default_max_blob_size(self):
        ...
        DefaultMaxBlobSize is the default maximum blob size for API responses  # noqa: E501
    ...
    @property
    def default_max_response_size(self):
        """Gets the default_max_response_size of this GeneralAPISettings.  # noqa: E501

        DefaultMaxResponseSize is the default maximum response size  # noqa: E501

        :return: The default_max_response_size of this GeneralAPISettings.  # noqa: E501
        :rtype: int
        """
        return self._default_max_response_size

    @default_max_response_size.setter
    def default_max_response_size(self, default_max_response_size):
        """Sets the default_max_response_size of this GeneralAPISettings.

        DefaultMaxResponseSize is the default maximum response size  # noqa: E501

        :param default_max_response_size: The default_max_response_size of this GeneralAPISettings.  # noqa: E501
        :type: int
        """
    ...
    def default_paging_num(self):
        ...
        DefaultPagingNum is the default number of items per page  # noqa: E501
    ...
    def max_response_items(self):
        ...
        MaxResponseItems is the maximum number of items returned in API responses  # noqa: E501
