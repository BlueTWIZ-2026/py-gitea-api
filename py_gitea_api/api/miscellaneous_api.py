...
class MiscellaneousApi(object):
    ...
    def get_signing_key_ssh(self, **kwargs):  # noqa: E501
        """Get default signing-key.pub  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_signing_key_ssh(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_signing_key_ssh_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_signing_key_ssh_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_signing_key_ssh_with_http_info(self, **kwargs):  # noqa: E501
        """Get default signing-key.pub  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_signing_key_ssh_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_signing_key_ssh" % key
                )
            params[key] = val
        del params['kwargs']
