...
class IssueApi(object):
    ...
    def issue_add_subscription(self, owner, repo, index, user, **kwargs):  # noqa: E501
        ...
        :param str repo: name of the repo (required)
        :param int index: index of the issue (required)
        :param str user: username of the user to subscribe the issue to (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def issue_delete_subscription(self, owner, repo, index, user, **kwargs):  # noqa: E501
        ...
        :param str repo: name of the repo (required)
        :param int index: index of the issue (required)
        :param str user: username of the user to unsubscribe from an issue (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def issue_lock_issue(self, owner, repo, index, **kwargs):  # noqa: E501
        """Lock an issue  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.issue_lock_issue(owner, repo, index, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.issue_lock_issue_with_http_info(owner, repo, index, **kwargs)  # noqa: E501
        else:
            (data) = self.issue_lock_issue_with_http_info(owner, repo, index, **kwargs)  # noqa: E501
            return data

    def issue_lock_issue_with_http_info(self, owner, repo, index, **kwargs):  # noqa: E501
        """Lock an issue  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.issue_lock_issue_with_http_info(owner, repo, index, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method issue_lock_issue" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'owner' is set
        if self.api_client.client_side_validation and ('owner' not in params or
                                                       params['owner'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `owner` when calling `issue_lock_issue`")  # noqa: E501
        # verify the required parameter 'repo' is set
        if self.api_client.client_side_validation and ('repo' not in params or
                                                       params['repo'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `repo` when calling `issue_lock_issue`")  # noqa: E501
        # verify the required parameter 'index' is set
        if self.api_client.client_side_validation and ('index' not in params or
                                                       params['index'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `index` when calling `issue_lock_issue`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/repos/{owner}/{repo}/issues/{index}/lock', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def issue_unlock_issue(self, owner, repo, index, **kwargs):  # noqa: E501
        """Unlock an issue  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.issue_unlock_issue(owner, repo, index, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.issue_unlock_issue_with_http_info(owner, repo, index, **kwargs)  # noqa: E501
        else:
            (data) = self.issue_unlock_issue_with_http_info(owner, repo, index, **kwargs)  # noqa: E501
            return data

    def issue_unlock_issue_with_http_info(self, owner, repo, index, **kwargs):  # noqa: E501
        """Unlock an issue  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.issue_unlock_issue_with_http_info(owner, repo, index, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method issue_unlock_issue" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'owner' is set
        if self.api_client.client_side_validation and ('owner' not in params or
                                                       params['owner'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `owner` when calling `issue_unlock_issue`")  # noqa: E501
        # verify the required parameter 'repo' is set
        if self.api_client.client_side_validation and ('repo' not in params or
                                                       params['repo'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `repo` when calling `issue_unlock_issue`")  # noqa: E501
        # verify the required parameter 'index' is set
        if self.api_client.client_side_validation and ('index' not in params or
                                                       params['index'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `index` when calling `issue_unlock_issue`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/repos/{owner}/{repo}/issues/{index}/lock', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
