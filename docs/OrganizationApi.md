...
api_instance = py_gitea_api.OrganizationApi(py_gitea_api.ApiClient(configuration))
...
# create an instance of the API class
api_instance = py_gitea_api.OrganizationApi(py_gitea_api.ApiClient(configuration))
organization = py_gitea_api.CreateOrgOption() # CreateOrgOption | 
...
api_instance = py_gitea_api.OrganizationApi(py_gitea_api.ApiClient(configuration))
org = 'org_example' # str | name of the organization
body = py_gitea_api.CreateTeamOption() # CreateTeamOption |  (optional)
...
body = py_gitea_api.EditOrgOption() # EditOrgOption | 
...
body = py_gitea_api.EditTeamOption() # EditTeamOption |  (optional)
...
body = py_gitea_api.RenameOrgOption() # RenameOrgOption | 
