...
api_instance = py_gitea_api.AdminApi(py_gitea_api.ApiClient(configuration))
username = 'username_example' # str | username of the user to whom a badge is to be added
body = py_gitea_api.UserBadgeOption() # UserBadgeOption |  (optional)
...
key = py_gitea_api.CreateKeyOption() # CreateKeyOption |  (optional)
...
repository = py_gitea_api.CreateRepoOption() # CreateRepoOption | 
...
# create an instance of the API class
api_instance = py_gitea_api.AdminApi(py_gitea_api.ApiClient(configuration))
body = py_gitea_api.CreateUserOption() # CreateUserOption |  (optional)
...
body = py_gitea_api.EditUserOption() # EditUserOption |  (optional)
...
body = py_gitea_api.RenameUserOption() # RenameUserOption | 
