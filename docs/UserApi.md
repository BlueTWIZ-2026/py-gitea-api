...
api_instance = py_gitea_api.UserApi(py_gitea_api.ApiClient(configuration))
...
# create an instance of the API class
api_instance = py_gitea_api.UserApi(py_gitea_api.ApiClient(configuration))
body = py_gitea_api.UserSettingsOptions() # UserSettingsOptions |  (optional)
...
# create an instance of the API class
api_instance = py_gitea_api.UserApi(py_gitea_api.ApiClient(configuration))
body = py_gitea_api.CreateEmailOption() # CreateEmailOption |  (optional)
...
# create an instance of the API class
api_instance = py_gitea_api.UserApi(py_gitea_api.ApiClient(configuration))
body = py_gitea_api.CreateHookOption() # CreateHookOption | 
...
# create an instance of the API class
api_instance = py_gitea_api.UserApi(py_gitea_api.ApiClient(configuration))
body = py_gitea_api.CreateOAuth2ApplicationOptions() # CreateOAuth2ApplicationOptions | 
...
body = py_gitea_api.CreateAccessTokenOption() # CreateAccessTokenOption |  (optional)
...
# create an instance of the API class
api_instance = py_gitea_api.UserApi(py_gitea_api.ApiClient(configuration))
form = py_gitea_api.CreateGPGKeyOption() # CreateGPGKeyOption |  (optional)
...
# create an instance of the API class
api_instance = py_gitea_api.UserApi(py_gitea_api.ApiClient(configuration))
body = py_gitea_api.DeleteEmailOption() # DeleteEmailOption |  (optional)
...
# create an instance of the API class
api_instance = py_gitea_api.UserApi(py_gitea_api.ApiClient(configuration))
body = py_gitea_api.UpdateUserAvatarOption() # UpdateUserAvatarOption |  (optional)
