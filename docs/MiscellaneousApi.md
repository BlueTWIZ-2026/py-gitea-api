...
api_instance = py_gitea_api.MiscellaneousApi(py_gitea_api.ApiClient(configuration))
...
# create an instance of the API class
api_instance = py_gitea_api.MiscellaneousApi(py_gitea_api.ApiClient(configuration))
body = py_gitea_api.MarkdownOption() # MarkdownOption |  (optional)
...
# create an instance of the API class
api_instance = py_gitea_api.MiscellaneousApi(py_gitea_api.ApiClient(configuration))
body = py_gitea_api.MarkupOption() # MarkupOption |  (optional)
