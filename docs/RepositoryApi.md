...
import time
import py_gitea_api
from py_gitea_api.rest import ApiException
from pprint import pprint

# Configure API key authorization: AccessToken
configuration = py_gitea_api.Configuration()
...
api_instance = py_gitea_api.RepositoryApi(py_gitea_api.ApiClient(configuration))
...
repo = 'repo_example' # str | name of the repo
workflow_id = 'workflow_id_example' # str | id of the workflow
body = py_gitea_api.CreateActionWorkflowDispatch() # CreateActionWorkflowDispatch |  (optional)
...
# create an instance of the API class
api_instance = py_gitea_api.RepositoryApi(py_gitea_api.ApiClient(configuration))
body = py_gitea_api.CreateRepoOption() # CreateRepoOption |  (optional)
...
body = py_gitea_api.CreateForkOption() # CreateForkOption |  (optional)
...
body = py_gitea_api.CreateVariableOption() # CreateVariableOption |  (optional)
...
body = py_gitea_api.GenerateRepoOption() # GenerateRepoOption |  (optional)
...
body = py_gitea_api.AddCollaboratorOption() # AddCollaboratorOption |  (optional)
...
owner = 'owner_example' # str | owner of the repo
repo = 'repo_example' # str | name of the repo
body = py_gitea_api.CreatePushMirrorOption() # CreatePushMirrorOption |  (optional)
...
owner = 'owner_example' # str | owner of the repo
repo = 'repo_example' # str | name of the repo
body = py_gitea_api.ApplyDiffPatchFileOptions() # ApplyDiffPatchFileOptions | 
...
owner = 'owner_example' # str | owner of the repo
repo = 'repo_example' # str | name of the repo
body = py_gitea_api.ChangeFilesOptions() # ChangeFilesOptions | 
...
owner = 'owner_example' # str | owner of the repo
repo = 'repo_example' # str | name of the repo
body = py_gitea_api.CreateBranchRepoOption() # CreateBranchRepoOption |  (optional)
...
owner = 'owner_example' # str | owner of the repo
repo = 'repo_example' # str | name of the repo
body = py_gitea_api.CreateBranchProtectionOption() # CreateBranchProtectionOption |  (optional)
...
body = py_gitea_api.CreateFileOptions() # CreateFileOptions | 
...
owner = 'owner_example' # str | owner of the repo
repo = 'repo_example' # str | name of the repo
body = py_gitea_api.CreateHookOption() # CreateHookOption |  (optional)
...
owner = 'owner_example' # str | owner of the repo
repo = 'repo_example' # str | name of the repo
body = py_gitea_api.CreateKeyOption() # CreateKeyOption |  (optional)
...
owner = 'owner_example' # str | owner of the repo
repo = 'repo_example' # str | name of the repo
body = py_gitea_api.CreatePullRequestOption() # CreatePullRequestOption |  (optional)
...
body = py_gitea_api.CreatePullReviewOptions() # CreatePullReviewOptions | 
...
repo = 'repo_example' # str | name of the repo
index = 789 # int | index of the pull request
body = py_gitea_api.PullReviewRequestOptions() # PullReviewRequestOptions | 
...
owner = 'owner_example' # str | owner of the repo
repo = 'repo_example' # str | name of the repo
body = py_gitea_api.CreateReleaseOption() # CreateReleaseOption |  (optional)
...
repo = 'repo_example' # str | name of the repo
sha = 'sha_example' # str | sha of the commit
body = py_gitea_api.CreateStatusOption() # CreateStatusOption |  (optional)
...
owner = 'owner_example' # str | owner of the repo
repo = 'repo_example' # str | name of the repo
body = py_gitea_api.CreateTagOption() # CreateTagOption |  (optional)
...
owner = 'owner_example' # str | owner of the repo
repo = 'repo_example' # str | name of the repo
body = py_gitea_api.CreateTagProtectionOption() # CreateTagProtectionOption |  (optional)
...
owner = 'owner_example' # str | owner of the repo
repo = 'repo_example' # str | name of the repo
body = py_gitea_api.CreateWikiPageOptions() # CreateWikiPageOptions |  (optional)
...
body = py_gitea_api.DeleteFileOptions() # DeleteFileOptions | 
...
index = 789 # int | index of the pull request
id = 789 # int | id of the review
body = py_gitea_api.DismissPullReviewOptions() # DismissPullReviewOptions | 
...
body = py_gitea_api.EditRepoOption() # EditRepoOption | Properties of a repo that you can edit (optional)
...
repo = 'repo_example' # str | name of the repo
name = 'name_example' # str | name of protected branch
body = py_gitea_api.EditBranchProtectionOption() # EditBranchProtectionOption |  (optional)
...
repo = 'repo_example' # str | name of the repo
id = 'id_example' # str | id of the hook to get
body = py_gitea_api.EditGitHookOption() # EditGitHookOption |  (optional)
...
body = py_gitea_api.EditHookOption() # EditHookOption |  (optional)
...
body = py_gitea_api.EditPullRequestOption() # EditPullRequestOption |  (optional)
...
body = py_gitea_api.EditReleaseOption() # EditReleaseOption |  (optional)
...
body = py_gitea_api.EditAttachmentOptions() # EditAttachmentOptions |  (optional)
...
repo = 'repo_example' # str | name of the repo
id = 56 # int | id of protected tag
body = py_gitea_api.EditTagProtectionOption() # EditTagProtectionOption |  (optional)
...
> list[Commit] repo_get_all_commits(owner, repo, sha=sha, path=path, since=since, until=until, stat=stat, verification=verification, files=files, page=page, limit=limit, _not=_not)
...
try:
    # Get a list of all commits from a repository
    api_response = api_instance.repo_get_all_commits(owner, repo, sha=sha, path=path, since=since, until=until, stat=stat, verification=verification, files=files, page=page, limit=limit, _not=_not)
    pprint(api_response)
except ApiException as e:
...
owner = 'owner_example' # str | owner of the repo
repo = 'repo_example' # str | name of the repo
body = py_gitea_api.GetFilesOptions() # GetFilesOptions | 
ref = 'ref_example' # str | The name of the commit/branch/tag. Default to the repository’s default branch. (optional)
...
repo = 'repo_example' # str | name of the repo
index = 789 # int | index of the pull request to merge
body = py_gitea_api.MergePullRequestOption() # MergePullRequestOption |  (optional)
...
owner = 'owner_example' # str | owner of the repo
repo = 'repo_example' # str | name of the repo
body = py_gitea_api.MergeUpstreamRequest() # MergeUpstreamRequest |  (optional)
...
# create an instance of the API class
api_instance = py_gitea_api.RepositoryApi(py_gitea_api.ApiClient(configuration))
body = py_gitea_api.MigrateRepoOptions() # MigrateRepoOptions |  (optional)
...
body = py_gitea_api.RenameBranchRepoOption() # RenameBranchRepoOption |  (optional)
...
index = 789 # int | index of the pull request
id = 789 # int | id of the review
body = py_gitea_api.SubmitPullReviewOptions() # SubmitPullReviewOptions | 
...
owner = 'owner_example' # str | owner of the repo to transfer
repo = 'repo_example' # str | name of the repo to transfer
body = py_gitea_api.TransferRepoOption() # TransferRepoOption | Transfer Options
...
owner = 'owner_example' # str | owner of the repo
repo = 'repo_example' # str | name of the repo
body = py_gitea_api.UpdateRepoAvatarOption() # UpdateRepoAvatarOption |  (optional)
...
owner = 'owner_example' # str | owner of the repo
repo = 'repo_example' # str | name of the repo
body = py_gitea_api.UpdateBranchProtectionPriories() # UpdateBranchProtectionPriories |  (optional)
...
body = py_gitea_api.UpdateFileOptions() # UpdateFileOptions | 
...
owner = 'owner_example' # str | owner of the repo
repo = 'repo_example' # str | name of the repo
body = py_gitea_api.RepoTopicOptions() # RepoTopicOptions |  (optional)
...
repo = 'repo_example' # str | name of the repository
secretname = 'secretname_example' # str | name of the secret
body = py_gitea_api.CreateOrUpdateSecretOption() # CreateOrUpdateSecretOption |  (optional)
...
repo = 'repo_example' # str | name of the repository
variablename = 'variablename_example' # str | name of the variable
body = py_gitea_api.UpdateVariableOption() # UpdateVariableOption |  (optional)
